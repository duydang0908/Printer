...
public abstract class BasePrint {
    ...
    private void getPreferences() {
        ...
        boolean store_isAutoCut = sharedPreferences.getBoolean("store_isAutoCut", true);
        boolean store_isCutAtEnd = sharedPreferences.getBoolean("store_isCutAtEnd", true);
        boolean store_isHalfCut = sharedPreferences.getBoolean("store_isHalfCut", true);
        boolean store_isSpecialTape = sharedPreferences.getBoolean("store_isSpecialTape", false);
        int store_size_page = sharedPreferences.getInt("store_size_page", 9);
        String input;
        mPrinterInfo.printerModel = Model.PT_P750W;
        mPrinterInfo.port = PrinterInfo.Port.NET;
        mPrinterInfo.ipAddress = store_device_address;
        mPrinterInfo.macAddress = "";
        if (isLabelPrinter(mPrinterInfo.printerModel)) {
            ...
            switch (mPrinterInfo.printerModel) {
                ...
                case PT_P950NW:
                    ...
                    if (store_size_page == 9) {
                        mPrinterInfo.labelNameIndex = LabelInfo.PT.W9
                                .ordinal();
                    } else if (store_size_page == 12) {
                        mPrinterInfo.labelNameIndex = LabelInfo.PT.W12
                                .ordinal();
                    }
                    if (store_size_page == 18) {
                        mPrinterInfo.labelNameIndex = LabelInfo.PT.W18
                                .ordinal();
                    }
                    if (store_size_page == 24) {
                        mPrinterInfo.labelNameIndex = LabelInfo.PT.W24
                                .ordinal();
                    }
                    mPrinterInfo.isAutoCut = store_isAutoCut;
                    mPrinterInfo.isCutAtEnd = store_isCutAtEnd;
                    mPrinterInfo.isHalfCut = store_isHalfCut;
                    mPrinterInfo.isSpecialTape = store_isSpecialTape;
                    break;
                default:
                    break;
            }
        ...
        mPrinterInfo.align = PrinterInfo.Align.LEFT;
    ...
    public String getBattery() {
        ...
        if (mPrinterInfo.printerModel == PrinterInfo.Model.MW_260
            ...
            if (mPrintResult.batteryLevel > 80) {
                ...
                || mPrinterInfo.printerModel == Model.PT_E500
                || mPrinterInfo.printerModel == Model.PT_P750W
